    ...
    <div className="mb-10 relative backdrop-blur-sm border border-border  p-6">
      ...
      <div className="flex flex-col md:flex-row items-start md:items-center gap-6">
        ...
        <div className="w-full">
          <div className="flex flex-col md:flex-row md:items-center justify-between gap-2 mb-2 truncate max-w-[100%]">
          ...
          <p className="text-muted-foreground font-mono truncate max-w-[100%]">
